...
📦 Shipped: role-based marketplace API with negotiation/order flow, multi-vendor backend with buyer/seller/admin roles,&emsp; Docker-ready deployments with documented endpoints<br>
